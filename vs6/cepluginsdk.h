...
typedef BOOL (__stdcall *CEP_NAMETOADDRESS) (const char *name, UINT_PTR *address);
...
typedef PVOID (__stdcall *CEP_GETLUASTATE)(VOID);

typedef VOID (__stdcall *CEP_PLUGINFUNC)(LPVOID parameters);
typedef PVOID (__stdcall *CEP_MAINTHREADCALL)(CEP_PLUGINFUNC func, LPVOID paramters);
